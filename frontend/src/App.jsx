...
// 💥 FIX CRUCIAL: Capturamos la variable de entorno definida en Vercel
...
    if (!libroInput.trim()) return;
    ...
    // 💥 SEGURIDAD: Verifica que la URL de la API esté configurada antes de continuar
    if (!API_BASE_URL) {
        setMensaje("Error: La URL de la API no está configurada. Verifica la variable VITE_API_URL en Vercel.");
        setCargando(false);
...
    try {
      // 💥 CORRECCIÓN: Usamos la variable de entorno para construir la URL completa de Fly.io
